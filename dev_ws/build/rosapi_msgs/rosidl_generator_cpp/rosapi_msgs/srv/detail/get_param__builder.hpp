...
class Init_GetParam_Response_reason
{
public:
  explicit Init_GetParam_Response_reason(::rosapi_msgs::srv::GetParam_Response & msg)
  : msg_(msg)
  {}
  ::rosapi_msgs::srv::GetParam_Response reason(::rosapi_msgs::srv::GetParam_Response::_reason_type arg)
  {
...
class Init_GetParam_Response_successful
{
public:
  explicit Init_GetParam_Response_successful(::rosapi_msgs::srv::GetParam_Response & msg)
  : msg_(msg)
  {}
  Init_GetParam_Response_reason successful(::rosapi_msgs::srv::GetParam_Response::_successful_type arg)
  {
    msg_.successful = std::move(arg);
    return Init_GetParam_Response_reason(msg_);
  }
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetParam_Response_successful value(::rosapi_msgs::srv::GetParam_Response::_value_type arg)
  {
    msg_.value = std::move(arg);
    return Init_GetParam_Response_successful(msg_);
  }
