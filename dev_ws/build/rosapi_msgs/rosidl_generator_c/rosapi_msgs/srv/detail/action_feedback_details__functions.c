...
rosapi_msgs__srv__ActionFeedbackDetails_Request__init(rosapi_msgs__srv__ActionFeedbackDetails_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->type)) {
    rosapi_msgs__srv__ActionFeedbackDetails_Request__fini(msg);
    return false;
  }
  return true;
}
...
rosapi_msgs__srv__ActionFeedbackDetails_Request__create()
{
  ...
  rosapi_msgs__srv__ActionFeedbackDetails_Request * msg = (rosapi_msgs__srv__ActionFeedbackDetails_Request *)allocator.allocate(sizeof(rosapi_msgs__srv__ActionFeedbackDetails_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosapi_msgs__srv__ActionFeedbackDetails_Request));
  bool success = rosapi_msgs__srv__ActionFeedbackDetails_Request__init(msg);
  if (!success) {
...
rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence__init(rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosapi_msgs__srv__ActionFeedbackDetails_Request * data = NULL;

  if (size) {
    data = (rosapi_msgs__srv__ActionFeedbackDetails_Request *)allocator.zero_allocate(size, sizeof(rosapi_msgs__srv__ActionFeedbackDetails_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosapi_msgs__srv__ActionFeedbackDetails_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosapi_msgs__srv__ActionFeedbackDetails_Request__fini(&data[i - 1]);
      }
...
rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence__fini(rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosapi_msgs__srv__ActionFeedbackDetails_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence * array = (rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence *)allocator.allocate(sizeof(rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence__init(array, size);
  if (!success) {
...
rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence__destroy(rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence__are_equal(const rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence * lhs, const rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosapi_msgs__srv__ActionFeedbackDetails_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosapi_msgs__srv__ActionFeedbackDetails_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosapi_msgs__srv__ActionFeedbackDetails_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosapi_msgs__srv__ActionFeedbackDetails_Request * data =
      (rosapi_msgs__srv__ActionFeedbackDetails_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosapi_msgs__srv__ActionFeedbackDetails_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosapi_msgs__srv__ActionFeedbackDetails_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosapi_msgs__srv__ActionFeedbackDetails_Request__copy(
...
rosapi_msgs__srv__ActionFeedbackDetails_Response__init(rosapi_msgs__srv__ActionFeedbackDetails_Response * msg)
{
  ...
  if (!rosapi_msgs__msg__TypeDef__Sequence__init(&msg->typedefs, 0)) {
    rosapi_msgs__srv__ActionFeedbackDetails_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosapi_msgs__srv__ActionFeedbackDetails_Response * msg = (rosapi_msgs__srv__ActionFeedbackDetails_Response *)allocator.allocate(sizeof(rosapi_msgs__srv__ActionFeedbackDetails_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosapi_msgs__srv__ActionFeedbackDetails_Response));
  bool success = rosapi_msgs__srv__ActionFeedbackDetails_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence__init(rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosapi_msgs__srv__ActionFeedbackDetails_Response * data = NULL;

  if (size) {
    data = (rosapi_msgs__srv__ActionFeedbackDetails_Response *)allocator.zero_allocate(size, sizeof(rosapi_msgs__srv__ActionFeedbackDetails_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosapi_msgs__srv__ActionFeedbackDetails_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rosapi_msgs__srv__ActionFeedbackDetails_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence__fini(rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rosapi_msgs__srv__ActionFeedbackDetails_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence * array = (rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence *)allocator.allocate(sizeof(rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence__destroy(rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence__are_equal(const rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence * lhs, const rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosapi_msgs__srv__ActionFeedbackDetails_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosapi_msgs__srv__ActionFeedbackDetails_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosapi_msgs__srv__ActionFeedbackDetails_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosapi_msgs__srv__ActionFeedbackDetails_Response * data =
      (rosapi_msgs__srv__ActionFeedbackDetails_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosapi_msgs__srv__ActionFeedbackDetails_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosapi_msgs__srv__ActionFeedbackDetails_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosapi_msgs__srv__ActionFeedbackDetails_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
