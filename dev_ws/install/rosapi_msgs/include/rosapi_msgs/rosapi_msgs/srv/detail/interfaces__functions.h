...
#ifndef ROSAPI_MSGS__SRV__DETAIL__INTERFACES__FUNCTIONS_H_
#define ROSAPI_MSGS__SRV__DETAIL__INTERFACES__FUNCTIONS_H_
...
/// Initialize srv/Interfaces message.
/**
...
/// Finalize srv/Interfaces message.
/**
...
/// Create srv/Interfaces message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosapi_msgs__srv__Interfaces_Request__init().
...
/// Destroy srv/Interfaces message.
/**
 * It calls
 * rosapi_msgs__srv__Interfaces_Request__fini()
...
/// Check for srv/Interfaces message equality.
/**
...
/// Initialize array of srv/Interfaces messages.
/**
...
/// Finalize array of srv/Interfaces messages.
/**
 * It calls
 * rosapi_msgs__srv__Interfaces_Request__fini()
...
/// Create array of srv/Interfaces messages.
/**
 * It allocates the memory for the array and calls
 * rosapi_msgs__srv__Interfaces_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Interfaces messages.
/**
 * It calls
 * rosapi_msgs__srv__Interfaces_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Interfaces message array equality.
/**
...
/// Copy an array of srv/Interfaces messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosapi_msgs__srv__Interfaces_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosapi_msgs
...
/**
 * It calls
 * rosapi_msgs__srv__Interfaces_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rosapi_msgs
...
/**
 * It allocates the memory for the array and calls
 * rosapi_msgs__srv__Interfaces_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosapi_msgs
...
/**
 * It calls
 * rosapi_msgs__srv__Interfaces_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROSAPI_MSGS__SRV__DETAIL__INTERFACES__FUNCTIONS_H_
