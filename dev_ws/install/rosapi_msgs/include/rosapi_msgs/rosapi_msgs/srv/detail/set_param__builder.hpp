...
class Init_SetParam_Response_reason
{
public:
  explicit Init_SetParam_Response_reason(::rosapi_msgs::srv::SetParam_Response & msg)
  : msg_(msg)
  {}
  ::rosapi_msgs::srv::SetParam_Response reason(::rosapi_msgs::srv::SetParam_Response::_reason_type arg)
  {
...
private:
  ::rosapi_msgs::srv::SetParam_Response msg_;
};

class Init_SetParam_Response_successful
{
public:
  Init_SetParam_Response_successful()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetParam_Response_reason successful(::rosapi_msgs::srv::SetParam_Response::_successful_type arg)
  {
    msg_.successful = std::move(arg);
    return Init_SetParam_Response_reason(msg_);
  }
...
{
  return rosapi_msgs::srv::builder::Init_SetParam_Response_successful();
}
